 ...
 */
@Service
public class ModbusTcpOperatorService implements PlcService {
    ...
    public void connect() throws PlcConnectionException {
        ...
        try {
            ...
            throw new PlcConnectionException("Modbus TCP连接失败", e);
        }
    }
    ...
    public void write(String address, Object value) throws PlcWriteException {
        ...
        System.out.println("写入Modbus TCP: " + address + " = " + value);
    }
